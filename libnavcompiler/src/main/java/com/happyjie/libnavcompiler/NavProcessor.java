package com.happyjie.libnavcompiler;
    ...
    public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
        ...
        if (!fragmentElements.isEmpty() || !activityElements.isEmpty()) {
            ...
            try {
                ...
                //StandardLocation.SOURCE_OUTPUT：java文件的位置，一般在/com.happyjie.jetpack/app/build/generated/source/apt/目录下
